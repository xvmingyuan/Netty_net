...
/**
 * Protobuf type {@code proto.StudentResponseList}
 */
public  final class StudentResponseList extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:proto.StudentResponseList)
...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              studentResponse_ = new java.util.ArrayList<proto.StudentResponse>();
              mutable_bitField0_ |= 0x00000001;
            }
            studentResponse_.add(
                input.readMessage(proto.StudentResponse.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return proto.StudentProto.internal_static_proto_StudentResponseList_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return proto.StudentProto.internal_static_proto_StudentResponseList_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            proto.StudentResponseList.class, proto.StudentResponseList.Builder.class);
  }

  public static final int STUDENTRESPONSE_FIELD_NUMBER = 1;
  private java.util.List<proto.StudentResponse> studentResponse_;
  /**
   * <code>repeated .proto.StudentResponse studentResponse = 1;</code>
   */
  public java.util.List<proto.StudentResponse> getStudentResponseList() {
    return studentResponse_;
  }
  /**
   * <code>repeated .proto.StudentResponse studentResponse = 1;</code>
   */
  public java.util.List<? extends proto.StudentResponseOrBuilder> 
   ...
   * <code>repeated .proto.StudentResponse studentResponse = 1;</code>
   */
  public proto.StudentResponse getStudentResponse(int index) {
    return studentResponse_.get(index);
  }
  /**
   * <code>repeated .proto.StudentResponse studentResponse = 1;</code>
   */
  public proto.StudentResponseOrBuilder getStudentResponseOrBuilder(
      int index) {
    return studentResponse_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof proto.StudentResponseList)) {
      return super.equals(obj);
    }
    proto.StudentResponseList other = (proto.StudentResponseList) obj;
  ...
  public static proto.StudentResponseList parseFrom(
  ...
  public static proto.StudentResponseList parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static proto.StudentResponseList parseFrom(
  ...
  public static proto.StudentResponseList parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static proto.StudentResponseList parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static proto.StudentResponseList parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(proto.StudentResponseList prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:proto.StudentResponseList)
      proto.StudentResponseListOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return proto.StudentProto.internal_static_proto_StudentResponseList_descriptor;
    }
    ...
    // Construct using proto.StudentResponseList.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public proto.StudentResponseList getDefaultInstanceForType() {
      return proto.StudentResponseList.getDefaultInstance();
    }

    @java.lang.Override
    public proto.StudentResponseList build() {
      proto.StudentResponseList result = buildPartial();
    ...
    @java.lang.Override
    public proto.StudentResponseList buildPartial() {
      proto.StudentResponseList result = new proto.StudentResponseList(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof proto.StudentResponseList) {
        return mergeFrom((proto.StudentResponseList)other);
      } else {
    ...
    public Builder mergeFrom(proto.StudentResponseList other) {
      if (other == proto.StudentResponseList.getDefaultInstance()) return this;
      if (studentResponseBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      proto.StudentResponseList parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (proto.StudentResponseList) e.getUnfinishedMessage();
    ...
    private void ensureStudentResponseIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        studentResponse_ = new java.util.ArrayList<proto.StudentResponse>(studentResponse_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        proto.StudentResponse, proto.StudentResponse.Builder, proto.StudentResponseOrBuilder> studentResponseBuilder_;
    ...
    public Builder setStudentResponse(
        int index, proto.StudentResponse value) {
      if (studentResponseBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setStudentResponse(
        int index, proto.StudentResponse.Builder builderForValue) {
      if (studentResponseBuilder_ == null) {
        ensureStudentResponseIsMutable();
     ...
     * <code>repeated .proto.StudentResponse studentResponse = 1;</code>
     */
    public Builder addStudentResponse(proto.StudentResponse value) {
      if (studentResponseBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addStudentResponse(
        proto.StudentResponse.Builder builderForValue) {
      if (studentResponseBuilder_ == null) {
        ensureStudentResponseIsMutable();
    ...
    public Builder addAllStudentResponse(
        java.lang.Iterable<? extends proto.StudentResponse> values) {
      if (studentResponseBuilder_ == null) {
        ensureStudentResponseIsMutable();
     ...
     * <code>repeated .proto.StudentResponse studentResponse = 1;</code>
     */
    public proto.StudentResponse.Builder getStudentResponseBuilder(
        int index) {
     ...
     * <code>repeated .proto.StudentResponse studentResponse = 1;</code>
     */
    public proto.StudentResponse.Builder addStudentResponseBuilder() {
    ...
    public proto.StudentResponse.Builder addStudentResponseBuilder(
        int index) {
      return getStudentResponseFieldBuilder().addBuilder(
          index, proto.StudentResponse.getDefaultInstance());
    }
    /**
     * <code>repeated .proto.StudentResponse studentResponse = 1;</code>
     */
    public java.util.List<proto.StudentResponse.Builder> 
         getStudentResponseBuilderList() {
      return getStudentResponseFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        proto.StudentResponse, proto.StudentResponse.Builder, proto.StudentResponseOrBuilder> 
        getStudentResponseFieldBuilder() {
      if (studentResponseBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:proto.StudentResponseList)
  }

  // @@protoc_insertion_point(class_scope:proto.StudentResponseList)
  private static final proto.StudentResponseList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new proto.StudentResponseList();
  }

  public static proto.StudentResponseList getDefaultInstance() {
